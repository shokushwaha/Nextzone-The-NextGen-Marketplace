                ...
                <div className='flex flex-col gap-8 mt-8'>
                    ...
                    <div className='flex flex-col items-start justify-start bg-white px-4 py-2 rounded-md shadow-md'>
                        <span className='flex items-center gap-2 justify-center'>
                            ...
                            <span className='text-2xl mb-2 pl-1 pr-2 font-extrabold '>
                                Token Issuing & Redemtion Policy
                            </span>
                        </span>
                        <span className='w-[420px] bg-black h-[2px] mt-[-4px]'></span>
                    ...
                    <div className='flex flex-col items-start justify-start bg-white px-4 py-2 rounded-md shadow-md'>
                        ...
                        <span className='w-[160px] bg-black h-[2px] mt-[-4px]'></span>
                        <ul className='flex flex-col gap-1 mt-2'>
                            <li className='flex items-center gap-4'>
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    ...
                    <div className='flex flex-col items-start justify-start bg-white px-4 py-2 rounded-md shadow-md'>
                        ...
                        <span className='w-[280px] bg-black h-[2px] mt-[-4px]'></span>
                        <ul className='flex flex-col gap-1 mt-2'>
                            <li className='flex items-center gap-4'>
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    ...
                    <div className='flex flex-col items-start justify-start bg-white px-4 py-2 rounded-md shadow-md'>
                        ...
                        <span className='w-[260px] bg-black h-[2px] mt-[-4px]'></span>
                        <ul className='flex flex-col gap-1 mt-2'>
                            <li className='flex items-center gap-4'>
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    ...
                    <div className='flex flex-col items-start justify-start bg-white px-4 py-2 rounded-md shadow-md'>
                        ...
                        <span className='w-[410px] bg-black h-[2px] mt-[-4px]'></span>
                        <ul className='flex flex-col gap-1 mt-2'>
                            <li className='flex items-center gap-4'>
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    ...
                    <div className='flex flex-col items-start justify-start bg-white px-4 py-2 rounded-md shadow-md'>
                        ...
                        <span className='w-[400px] bg-black h-[2px] mt-[-4px]'></span>
                        <ul className='flex flex-col gap-1 mt-2'>
                            <li className='flex items-center gap-4'>
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    ...
                    <div className='flex flex-col items-start justify-start bg-white px-4 py-2 rounded-md shadow-md'>
                        ...
                        <span className='w-[120px] bg-black h-[2px] mt-[-4px]'></span>
                        <ul className='flex flex-col gap-1 mt-2'>
                            <li className='flex items-center gap-4'>
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
