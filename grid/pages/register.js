                        ...
                        <div className='flex flex-col gap-8 px-8 items-center justify-center ml-[-200px]'>
                            ...
                            <form onSubmit={handleRegister} className='flex gap-1 flex-col'>
                                ...
                                <div className='flex flex-col gap-1 mb-2'>
                                    ...
                                    <input type="text" placeholder='Enter Your Name' value={name} onChange={e => setName(e.target.value)} className=" pl-6 min-w-[300px] w-[30%] h-[2.5rem] rounded-xl focus:outline-none border-2 border-gray-300" />
                                </div>
                                ...
                                <div className='flex flex-col gap-1 mb-2'>
                                    ...
                                    <input type="text" placeholder='Enter Your Email' value={email} onChange={e => setEmail(e.target.value)} className=" pl-6 min-w-[300px] w-[30%] h-[2.5rem] rounded-xl focus:outline-none border-2 border-gray-300" />
                                </div>
                                ...
                                <div className='flex flex-col gap-1 mb-2'>
                                    ...
                                    <input type="password" placeholder='Enter Your Password' value={password} onChange={e => setPassword(e.target.value)} className=" pl-6 min-w-[300px] w-[30%] h-[2.5rem] rounded-xl focus:outline-none border-2 border-gray-300" />
                                ...
                                <div className='flex flex-col gap-1 mb-2'>
                                    ...
                                    <input type="text" placeholder='Enter Your Phone Number' value={phoneNum} onChange={e => setPhoneNum(e.target.value)} className=" pl-6 min-w-[300px] w-[30%] h-[2.5rem] rounded-xl focus:outline-none border-2 border-gray-300" />
                                </div>
                                ...
                                <div className='flex flex-col gap-1 mb-2'>
                                    ...
                                    <input type="text" placeholder='Enter Your Address' value={address} onChange={e => setAddress(e.target.value)} className=" pl-6 min-w-[300px] w-[30%] h-[2.5rem] rounded-xl focus:outline-none border-2 border-gray-300" />
